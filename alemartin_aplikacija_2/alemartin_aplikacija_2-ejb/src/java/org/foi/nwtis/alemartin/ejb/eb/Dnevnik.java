...
@NamedQueries({
    ...
    , @NamedQuery(name = "Dnevnik.findByVrstaZahtjeva", query = "SELECT d FROM Dnevnik d WHERE d.vrstaZahtjeva = :vrstaZahtjeva")
    , @NamedQuery(name = "Dnevnik.findBySadrzajZahtjeva", query = "SELECT d FROM Dnevnik d WHERE d.sadrzajZahtjeva = :sadrzajZahtjeva")
...
public class Dnevnik implements Serializable {
    ...
    public void setSadrzajZahtjeva(String sadrzajZahtjeva) {
        this.sadrzajZahtjeva = sadrzajZahtjeva;
    }
    ...
    public String toString() {
        return "org.foi.nwtis.alemartin.ejb.eb.Dnevnik[ id=" + id + " ]";
    }
